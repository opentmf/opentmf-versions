...
- Updated `opentmf-clients-base` to 1.1.10.
  - Fix double percent-encoding of resource path segments on get(id, TmfRequestContext) when the id contains RFC 3986 reserved characters.
  - Fix duplicate filter= / fields= query params on get(id, TmfRequestContext).

## [1.4.13] - 2026-05-14

### Changed

- Updated `dnext-opentmf-v4-models` to 1.1.1 (Adds DNext `TMF639` Resource Inventory models).

## [1.4.12] - 2026-05-10

### Changed

- Updated `opentmf-clients-base` to 1.1.9 (Adds `patchCollection` methods to TmfClient interface).

## [1.4.11] - 2026-03-30

### Changed

- Updated `dnext-catalog-sync-service` to 1.1.3 (Starts synchronizing product catalogs as well).

## [1.4.10] - 2026-03-28

### Changed

- Updated `dnext-catalog-sync-service` to 1.1.2 (Starts synchronizing product offering prices as well).
