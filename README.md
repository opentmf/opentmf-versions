...
| org.opentmf.mockserver | [opentmf-mockserver](https://github.com/opentmf/opentmf-mockserver)                 | jar    | [MockServer](https://mock-server.com/)-based test double that emulates a TMF-630 compliant backend.                       | 1.0.2   | 2.1.11  |
