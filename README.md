...
```xml
<properties>
  <opentmf-versions.version>2.1.27</opentmf-versions.version>
</properties>
...
| org.opentmf.security    | [openid-rbac-security](https://github.com/opentmf/openid-rbac-security)             | jar    | OpenID Connect authentication with role-based access control (RBAC) for Spring Boot.                                      | 1.1.0  | 3.2.0   |
