...
```xml
<properties>
  <opentmf-versions.version>2.1.14</opentmf-versions.version>
</properties>
...
| org.opentmf.client     | [opentmf-http-clients](https://github.com/opentmf/opentmf-http-clients)             | pom    | HTTP client foundation for REST and Reactive clients with unified configuration and cached bearer-token and mTLS support. | 2.0.0   | 2.1.4   |
