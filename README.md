...
| org.opentmf.cadenzaflow | [opentmf-cadenzaflow](https://github.com/opentmf/opentmf-cadenzaflow)               | jar    | Spring Boot 4 microservice embedding CadenzaFlow CE (the maintained Camunda 7 fork) with Spin, Keycloak OpenID, and RBAC. | 1.0.0  | 1.2.3   |
